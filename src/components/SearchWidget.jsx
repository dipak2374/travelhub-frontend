...
const SearchWidget = () => {
  ...
  const [search, setSearch] = useState({ origin: '', destination: '', checkIn: '', checkOut: '', passengers: 1 });
  ...
  const handleSearch = (e) => {
    ...
    if (search.passengers) params.set('passengers', search.passengers.toString());

    navigate(`/${activeTab}?${params.toString()}`);
  };

  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={(e) => setSearch({ ...search, passengers: Math.max(1, parseInt(e.target.value, 10) || 1) })}
            />
          </div>
